...
Home:AddParagraph('IIF制作','官方QQ群915792498')
Home:AddDropdown({
    Name = '脚本',
    Default = '',
...
game:GetService('Workspace').BlackMarket.BlackMarketBillboard.BottomLabel.Text = '向IIF出售物品以获得钱!'
game:GetService('Workspace').OhioSign.Screen.SurfaceGui.Frame.Population.Text = 'IIF祝您玩的愉快'
